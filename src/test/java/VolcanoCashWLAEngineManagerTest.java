...
public class VolcanoCashWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(VolcanoCashWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/VolcanoCashWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/VolcanoCashWLAIW/InitOutcome.xml").getDocumentElement();
